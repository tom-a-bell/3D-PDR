...
!  to the chemistry.log output file.
!
!-----------------------------------------------------------------------
SUBROUTINE ANALYSE_CHEMISTRY(NPART,NSPEC,NREAC,TIME,SPECIES,REACTANT, &
                           & PRODUCT,PARTICLE,AV_LIST,SPECIES_LIST)
