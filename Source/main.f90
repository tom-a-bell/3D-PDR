!=======================================================================
!
!  3D-PDR: a new three-dimensional astrochemistry and radiative transfer
!          code for modelling FUV- and X-ray-illuminated cloud complexes
!
!-----------------------------------------------------------------------
PROGRAM THREEDPDR
...
!!$   END IF
   ...
   WRITE(6,*)
   WRITE(6,*) 'Analysing chemistry...'

   CALL ANALYSE_CHEMISTRY(NPART,NSPEC,NREAC,END_TIME,SPECIES,REACTANT,PRODUCT,PARTICLE, &
                        & (/0.0D0,1.0D0,1.0D1,1.0D2,1.0D3,2.0D3,4.0D3,1.0D4/), &
                        & (/"H ","H2 ","C ","CO ","H+ ","O+ ","e- "/))
